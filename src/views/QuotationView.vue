  ...
  <div class="min-h-screen bg-gray-50" v-if="quotation">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="quotation-content">
          ...
          <div class="text-right">
            <div class="space-y-2">
              <div>
                ...
                <span class="ml-2 text-lg font-bold text-gray-900">{{ quotation.code }}</span>
              </div>
              <div>
                <span class="text-sm font-medium text-gray-600">Fecha:</span>
                <span class="ml-2 text-gray-900">{{ formatDate(quotation.date) }}</span>
              </div>
              <div>
      ...
      <div class="bento-box-lg bento-full-width mb-6 print-full-width">
        ...
        <div v-if="quotation.items.length === 0" class="text-center py-8 text-gray-500">
...
import { useQuotationsStore, type Quotation, type QuotationItem } from '@/stores/quotations'
import {
  ArrowLeftIcon,
  PencilIcon,
...
function addItem(): void {
  if (quotation.value) {
    ...
    quotation.value.items.push(newItem)
  }
}
...
function updateItemTotal(item: QuotationItem): void {
